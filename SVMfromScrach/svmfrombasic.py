...
data_dict_2 = {-1:np.array([[1,7],[2,8],[3,8]]), 1:np.array([[5,1],[6,-1],[7,3]])}
...
class SVM:
    ...
    def predict(self, features):
        ...
        elif (classify != 0 and self.visualization):
            self.axis.scatter(features[0], features[1], s=200, marker= '*', c=self.colors[classify])
        return classify
    ...
    def visualize(self):
        ...
        self.axis.plot([hyp_x_min,hyp_x_max],[dl1, dl2])
